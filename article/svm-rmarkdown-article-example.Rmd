...
output: 
  pdf_document:
    ...
    # setup the template file path 
    template: G:/project2/rmd-doc/rmd-doc/templates/svm-latex-ms.tex
...
Perhaps the greatest intrigue of R Markdown comes with the [`knitr` package](http://yihui.name/knitr/) provided by @xie2015dynamic . In other words, the author can, if she chooses, do the analysis in the Markdown document itself and compile/execute it in R.
