...
output: 
  pdf_document:
    citation_package: natbib #or natbib biblatex
    keep_tex: true
    fig_caption: true
    latex_engine: pdflatex
    template: G:/project2/rmd-doc/rmd-doc/templates/svm-latex-anon-ms.tex #change  "G:/project2/rmd-doc/rmd-doc/" to working directory 
...
fontfamily: mathpazo
fontsize: 11pt
#spacing: #is an optional field. If it is set as “double”, the ensuing document is double-spaced. “single” is the only other valid entry for this field, though not including the entry in the YAML metadata amounts to singlespacing the document by default. 
bibliography: G:/project2/rmd-doc/rmd-doc/templates/references.bib #change  "G:/project2/rmd-doc/rmd-doc/" to working directory 
biblio-style: apalike  #  or apsr
#http://rmarkdown.rstudio.com/authoring_bibliographies_and_citations.html#citation_styles
